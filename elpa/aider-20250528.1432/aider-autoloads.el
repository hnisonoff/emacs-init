...
(autoload 'aider-go-ahead "aider-discussion" "\
...
Drop current file from aider session." t)
...
(autoload 'aider-pull-or-review-diff-file "aider-file" "\
...
(autoload 'aider-open-history "aider-file" "\
...
(autoload 'aider-magit-blame-analyze "aider-file" "\
...
(defvar aider-prompt-mode-map (let ((map (make-sparse-keymap))) (define-key map (kbd "C-c C-n") #'aider-send-line-or-region) (define-key map (kbd "C-c C-c") #'aider-send-block-or-region) (define-key map (kbd "C-c C-b") #'aider-send-block-by-line) (define-key map (kbd "C-c C-z") #'aider-switch-to-buffer) (define-key map (kbd "C-c C-f") #'aider-prompt-insert-file-path) (define-key map (kbd "C-c C-i") #'aider-core-insert-prompt) (define-key map (kbd "C-c C-y") #'aider-prompt-cycle-file-command) map) "\
...
(autoload 'aider-prompt-insert-file-path "aider-prompt-mode" "\
